    ...
    <div class="tab-pane fade in active no-padding" id="quickview-chat">
      <div class="view-port clearfix" id="chat">
        <div class="view bg-white">
          ...
          <div data-init-list-view="ioslist" class="list-view boreded no-top-border">
            <?php
            foreach (array('J' => 'João', 'L' => 'Laura', 'M' => 'Maria') as $key => $value) {
              ?>
              <div class="list-view-group-container">
                <div class="list-view-group-header text-uppercase"><?php echo $key; ?></div>
                <ul>
                  ...
                  <li class="chat-user-list clearfix">
                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                      ...
                      <span class="thumbnail-wrapper d32 circular bg-success">
                          <img width="34" height="34" alt="" data-src-retina="<?php echo get_asset('img/profiles/1x.jpg'); ?>" data-src="<?php echo get_asset('img/profiles/1.jpg'); ?>" src="<?php echo get_asset('img/profiles/1x.jpg'); ?>" class="col-top">
                      </span>
                      </span>
                      <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        <span class="text-master"><?php echo $value; ?></span>
          ...
          <div class="chat-inner" id="my-conversation">
            ...
            <div class="message clearfix">
              <div class="profile-img-wrapper m-t-5 inline">
                <img class="col-top" width="30" height="30" src="<?php echo get_asset('img/profiles/avatar_small.jpg'); ?>" alt="" data-src="<?php echo get_asset('img/profiles/avatar_small.jpg'); ?>" data-src-retina="<?php echo get_asset('img/profiles/avatar_small2x.jpg'); ?>">
              </div>
