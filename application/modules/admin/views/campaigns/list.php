              ...
              <tbody>
                ...
                foreach ($campaigns['results'] as $campaign) {
                  ...
                  <tr>
                    ...
                    <td class="v-align-middle semi-bold"><?php echo $campaign['nome']; ?></td>
                    <td class="v-align-middle"><?php echo $campaign['status']; ?></td>
                    <td>
                      <a href="<?php echo base_url('admin/campanhas/'. $campaign['id'] .'/editar'); ?>" class="btn btn-info btn-xs">Editar</a>
                      <a href="javascript: void(0);" data-property_id="<?php echo $campaign['id']; ?>" data-property_reference="<?php echo $campaign['nome']; ?>" class="btn btn-danger btn-xs btn-delete">Excluir</a>
                    </td>
                  </tr>
                  <?php
