          ...
          <div class="padding-15">
            <div class="item-header clearfix">
              <div class="thumbnail-wrapper d32 circular">
                <img width="40" height="40" src="<?php echo get_asset('img/profiles/3x.jpg'); ?>" data-src="<?php echo get_asset('img/profiles/3.jpg'); ?>" data-src-retina="<?php echo get_asset('img/profiles/3x.jpg'); ?>" alt="">
              </div>
            ...
            <div class="panel no-border  no-margin">
              ...
              <div class="relative">
                ...
                <div class="widget-19-post no-overflow">
                  <img src="<?php echo get_asset('img/social-post-image.png'); ?>" class="block center-margin relative" alt="Post">
                </div>
              </div>
              <div class="padding-15">
                <div class="hint-text pull-left">few seconds ago</div>
