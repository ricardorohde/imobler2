...
(function($) {
    ...
    $(document).ready(function() {
        ...
        d3.json(app.get_asset_url('js/min_sales_chart.json'), function(data) {
        ...
        $('.widget-13-map').mapplic({
            source: app.get_asset_url('js/dashboard-map.json'),
            height: 465,
            sidebar: false,
            minimap: false,
            locations: true,
        ...
        //NVD3 Charts
        d3.json(app.get_asset_url('js/charts.json'), function(data) {
